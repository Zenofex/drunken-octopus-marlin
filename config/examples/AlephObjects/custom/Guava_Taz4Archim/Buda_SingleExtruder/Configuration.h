...
#define CUSTOM_MACHINE_NAME "TAZ 4" // <-- changed

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like http://www.uuidgenerator.net/version4
#define MACHINE_UUID "c3255c96-4097-4884-8ed0-ded2ff9bae61" // <-- changed
 ...
 */
#define TEMP_SENSOR_0 7 // <-- changed
...
#define TEMP_RESIDENCY_TIME     10 // <-- changed:  (seconds) Time to wait for hotend to "settle" in M109
#define TEMP_WINDOW              1 // <-- changed:  (°C) Temperature proximity for the "temperature reached" timer
#define TEMP_HYSTERESIS          3 // <-- changed:  (°C) Temperature proximity considered "close enough" to the target
...
#define HEATER_0_MAXTEMP 250 // <-- changed
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
...
#if ENABLED(PIDTEMP)
  #define PID_EDIT_MENU // <-- changed:  Add PID editing to the "Advanced Settings" menu. (~700 bytes of PROGMEM)
  #define PID_AUTOTUNE_MENU // <-- changed:  Add PID auto-tuning to the "Advanced Settings" menu. (~250 bytes of PROGMEM)
  ...
  // Buda 2.0 on 24V
  #define  DEFAULT_Kp 6 // <-- changed
  #define  DEFAULT_Ki .3 // <-- changed
  #define  DEFAULT_Kd 125 // <-- changed

  // Ultimaker
  //#define DEFAULT_Kp 28.79 // <-- changed
  //#define DEFAULT_Ki 1.91 // <-- changed
  //#define DEFAULT_Kd 108.51 // <-- changed
...
#define Z_SAFE_HOMING // <-- changed
  ...
  #define Z_SAFE_HOMING_X_POINT 10 // <-- changed:  X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT 10 // <-- changed:  Y point for Z homing when homing all axes (G28).
#endif

// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY 3000 // <-- changed
#define HOMING_FEEDRATE_Z  180 // <-- changed
...
//
#define ENCODER_PULSES_PER_STEP 2 // <-- changed

//
// Use this option to override the number of step signals required to
// move between next/prev menu items.
//
#define ENCODER_STEPS_PER_MENU_ITEM 1 // <-- changed
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU // <-- changed
...
//
#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER // <-- changed
 ...
 */
#define NUM_SERVOS 0 // <-- changed:  Servo index starts with 0 for M280 command
